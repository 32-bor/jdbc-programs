...
// Program to select all rows based on the sorting order of salaries

public class jdbcdurga11 {
    public static void main(String[] args) {
        ...
        String sql = String.format("SELECT * FROM employees ORDER BY esal ASC");
